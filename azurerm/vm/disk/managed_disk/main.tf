...
resource "azurerm_managed_disk" "hadley_resource" {
  ...
  gallery_image_reference_id  = var.create_option == "FromImage" && data.azurerm_shared_image_version.image_version[0] != null  ? data.azurerm_shared_image_version.image_version[0].id : null
